...
const StoneChipsRepair = () => {
  return (
    ...
    {/* Text Block Centered */}
<div className="bg-blue-50 text-gray-800 px-6 py-16 lg:px-24 lg:py-24 max-w-5xl w-full mx-auto rounded-xl shadow-xl text-center">

<h2 className="text-4xl font-extrabold text-blue-600 mb-6 border-b-2 border-blue-200 pb-3">
