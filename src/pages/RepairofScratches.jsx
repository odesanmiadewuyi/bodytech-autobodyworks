...
import repair_scratchesImg from "../assets/services/repair_scratches.jpg"; // Adjust path as needed

const RepairofScratches = () => {
  return (
...
export default RepairofScratches;
